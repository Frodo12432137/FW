...
OUTPUT_DIR = r"D:\app\weatherCorrection_fv\Predkosc\artifacts"
...
def load_and_prepare(sql_prognoza: str, sql_wykonanie: str) -> pd.DataFrame:
    ...
    merged['diff'] = merged["predkoscWiatruLokalizacja_wykonanie"] - merged["predkoscWiatru"]

    LAGS = list(range(4, 300))
...
def train_model(
    ...
    # uwzględniamy wszystkie kolumny zaczynające się od diff_lag_ jako cechy
    ...
    metadata = {
        ...
        "mse_test": mse,
        "target": "predkoscWiatru_wykonanie_minus_prognoza",
